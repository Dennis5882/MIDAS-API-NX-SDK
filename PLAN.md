...
| Live verification | `scripts/live_smoke.py` (write round trip), `scripts/live_readonly_sweep.py` (GET breadth) | ✅ 399/399 recorded, split by `level`: **190 write / 209 read / 0 unverified** as of 2026-09-06. Write level means a call changed model data or wrote a host file; read includes route/schema checks and POST-shaped reads. The current build baseline is Gen NX 2026 v2.1 and Civil NX 2026 v2.2, both Build 09/02/2026. |
