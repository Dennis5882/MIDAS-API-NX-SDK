...
> Last updated: 2026-09-22 — **2.9.2 released** (`js-v2.9.2`, `py-v2.9.2`).
...
> breaking at the type level. `src/midas_nx/` is identical to 2.9.1. See
> `docs/release_notes_v2.9.2.md`.
>
...
| TypeScript/npm SDK | `packages/typescript/` — ESM + CommonJS + declarations, Node.js 18+, Vitest/typecheck/build and packed-artifact smoke tests | ✅ npm `midas-nx` 2.9.2 published 2026-09-22; `js-v*` OIDC workflow and npm Trusted Publisher registration completed 2026-08-27. Versions have moved in lockstep with PyPI since 2.6.0 |
