...
> Last updated: 2026-09-17 — **2.8.3 published** to npm then PyPI (`js-v2.8.3`, `py-v2.8.3`): one npm type narrows
...
| Axis | Artifact | State |
|---|---|---|
| Tests | 1081 Python tests + 83 Vitest tests, mocked/local only | ✅ green, all of it. The contract-to-manual test that had failed on purpose since 2026-09-06 passes again: the manual repo's syncs through `a6947a7` (2026-09-15) were reflected 2026-09-16 |
...
| TypeScript/npm SDK | `packages/typescript/` — ESM + CommonJS + declarations, Node.js 18+, Vitest/typecheck/build and packed-artifact smoke tests | ✅ npm `midas-nx` 2.8.3 published 2026-09-17; `js-v*` OIDC workflow and npm Trusted Publisher registration completed 2026-08-27. Versions have moved in lockstep with PyPI since 2.6.0 |
