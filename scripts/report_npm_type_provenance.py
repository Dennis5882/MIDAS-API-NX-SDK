...
with them, then 77 once /db/STCT's erection-load table was. What the 69 left in `python:nested` are:

    19  children of the 6 unmergedTables roots (moving-load cases and
