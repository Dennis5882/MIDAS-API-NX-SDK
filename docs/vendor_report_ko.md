...
| 버전 | **v2.2 (build 06/18/2026)** — 전 항목 확인. A-1·A-2는 v2.1 (build 06/05/2026)에서도 확인 |
| 릴레이 | `https://moa-engineers.midasit.com:443/civil` |
| 클라이언트 | Python 3.13 + `requests` (SDK 미사용) |

| # | 대상 | 내용 | 심각도 |
| --- | --- | --- | --- |
| A-1 | `/db/NMAS` | **POST 1회로 프로그램이 종료됨.** 6회 재현, 2개 버전 | 치명적 |
...
- **6회 / 2개 버전에서 100% 재현**됩니다 (v2.1 build 06/05, v2.2 build 06/18).
