...
| 버전 | **2026-09-21에 두 제품(Gen NX 2026 v2.1, Civil NX 2026 v2.2)에서 A-3·A-4·A-6·A-8·A-9·A-10을 일괄 재확인**했습니다. 그날 `/info` 전수 스왈 결과가 Build 09/15/2026 기준 스냅샷과 일치합니다 |
| 재확인 안 된 항목 | A-2(재현이 테이블을 비움)·A-5(제품 종료가 필요)·A-7(Program Files 하위 문서 필요)는 Civil v2.2 (build 06/18/2026) 또는 2026-07-29가 마지막 측정입니다 |
