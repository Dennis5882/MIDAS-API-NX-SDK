...
| 버전 | Civil: **v2.2 (build 06/18/2026)** — 전 항목 확인. A-1·A-2는 v2.1 (build 06/05/2026)에서도 확인. Gen: **v2.1 (build 07/28/2026)** — A-1만, 3회 |
| 릴레이 | `https://moa-engineers.midasit.com:443/civil`, `.../gen` |
| 클라이언트 | Python 3.13 + `requests` (SDK 미사용) |

| # | 대상 | 내용 | 심각도 |
| --- | --- | --- | --- |
| A-1 | `/db/NMAS` | **POST 1회로 프로그램이 종료됨. CIVIL·GEN 양쪽 모두 재현, 9회 전부 재현** | 치명적 |
