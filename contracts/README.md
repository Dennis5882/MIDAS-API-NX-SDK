...
- **It renamed nothing.** Every value was seeded from the generator's own
  ...
  purpose.
- **It is optional, and its absence means the Python fallback.** 269 of the 304
  npm resources have one; the 35 without a contract keep taking their names from
...
| Promoted so far | 338 endpoints + 87 tables |
| Drafts awaiting review | 47 |
| Payload types the npm SDK now takes from contracts | 254 of 750 |
| DB resources the npm SDK now takes from contracts | 269 of 304 |
